export const btnClassNames =
  'bg-primary-500 text-base-50 rounded border border-transparent transition-colors duration-300 hover:bg-gray-50 hover:text-primary-500 hover:border-primary-500 flex gap-2 items-center py-2 px-5';
